...
import ValueTypeDiagnostic from "./ValueTypeDiagnostic";
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="font-[family-name:var(--font-body)] text-[var(--color-grey)] text-base">
          This is a positioning profile, not a grade. The pattern of your scores
      ...
      {/* Value Type Diagnostic — unique to this tool */}
      <ValueTypeDiagnostic />
